...
const dict = {
  ...
  uz: {
    ...
    about_role_intern: "UI/UX dizayner stajyori",
    about_desc_intern: "Haqiqiy raqamli mahsulotlar dizayniga hissa qo'shgan holda intensiv stajirovka dasturini yakunladi.",
